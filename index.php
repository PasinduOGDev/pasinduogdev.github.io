...
<body>
    ...
    <div id="home-area">
        <div class="content">
                ...
                <div class="container">
                    <div class="hero-text">
                        ...
                        <div class="typewriter">
                            <h4 class="text-white opacity-75">I'm a&nbsp;<a class="typewrite text-decoration-none" data-period="2000"
                                    data-type='[ "Developer.", "UX/UI Engineer.", "YouTuber.","Freelancer." ]'>
            ...
            <section>
                <div id="about-area">
                    <div class="hero-section p-3 mt-5">
                        <div class="overlay"></div>
                        <div class="container reveal fade-bottom">

                            <div class="row mt-5 justify-content-center">
                                <div class="col-12 p-3 text-uppercase"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <p>Welcome to the digital realm of Pasindu OG Dev, a dynamic and
                                                    ...
                                                    (Hons)
                                                    in
                                                    Software Engineering at Java Institute.</p>
                                                ...
                                                <p>With an unwavering commitment to excellence, I am not just an
                                                    ...
                                                    pursuit
                                                    of
                                                    greatness in the changing world of software engineering.</p>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <div class="row g-3 mt-5 mt-lg-0">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <textarea rows="10" class="col-12 bg-dark form-control"
